...
if(JELLYFRAME_ENABLE_CANVAS2D AND JELLYFRAME_ENABLE_MODERN_PAINT AND JELLYFRAME_ENABLE_FLEX_GRID)
    set(JELLYFRAME_RENDER_CORE_PROFILE_ID "render-core-default")
elseif(NOT JELLYFRAME_ENABLE_FLEX_GRID AND JELLYFRAME_ENABLE_CANVAS2D AND JELLYFRAME_ENABLE_MODERN_PAINT)
    set(JELLYFRAME_RENDER_CORE_PROFILE_ID "render-core-no-flex-grid")
elseif(JELLYFRAME_ENABLE_FLEX_GRID AND NOT JELLYFRAME_ENABLE_CANVAS2D AND JELLYFRAME_ENABLE_MODERN_PAINT)
    set(JELLYFRAME_RENDER_CORE_PROFILE_ID "render-core-no-canvas")
elseif(JELLYFRAME_ENABLE_FLEX_GRID AND JELLYFRAME_ENABLE_CANVAS2D AND NOT JELLYFRAME_ENABLE_MODERN_PAINT)
    set(JELLYFRAME_RENDER_CORE_PROFILE_ID "render-core-no-modern-paint")
elseif(NOT JELLYFRAME_ENABLE_FLEX_GRID AND JELLYFRAME_ENABLE_CANVAS2D AND NOT JELLYFRAME_ENABLE_MODERN_PAINT)
    set(JELLYFRAME_RENDER_CORE_PROFILE_ID "render-core-no-flex-grid-no-modern-paint")
elseif(NOT JELLYFRAME_ENABLE_FLEX_GRID AND NOT JELLYFRAME_ENABLE_CANVAS2D AND JELLYFRAME_ENABLE_MODERN_PAINT)
    set(JELLYFRAME_RENDER_CORE_PROFILE_ID "render-core-no-flex-grid-no-canvas")
elseif(JELLYFRAME_ENABLE_FLEX_GRID AND NOT JELLYFRAME_ENABLE_CANVAS2D AND NOT JELLYFRAME_ENABLE_MODERN_PAINT)
    set(JELLYFRAME_RENDER_CORE_PROFILE_ID "render-core-no-modern-paint-no-canvas")
else()
