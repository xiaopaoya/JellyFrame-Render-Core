...
This directory is the entry point for Render Core design and maintenance
documentation.

- [architecture.md](architecture.md): ownership boundary, pipeline structure,
...
The JellyFrame Runtime repository owns App-package, JerryScript, desktop-tool
